    ...
    >
      ...
      <SortableOverlay>
        <div className="flex items-center gap-2">
          <div className="bg-primary/10 rounded-sm w-[180px] h-8" />
          <div className="bg-primary/10 rounded-sm w-24 h-8" />
      ...
      >
        <Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
          <PopoverTrigger asChild>
            <Button
              ...
              variant="outline"
              size="sm"
              className="justify-between rounded w-44 font-normal"
            >
          ...
          <PopoverContent
            id={fieldListboxId}
            className="p-0 w-[var(--radix-popover-trigger-width)] origin-[var(--radix-popover-content-transform-origin)]"
          >
            <Command>
        ...
        >
          <SelectTrigger
            ...
            className="rounded w-24 h-8 [&[data-size]]:h-8"
          >
            <SelectValue />
          </SelectTrigger>
          <SelectContent
            id={directionListboxId}
            className="origin-[var(--radix-select-content-transform-origin)] min-w-[var(--radix-select-trigger-width)]"
          >
        ...
        <Button
          ...
          variant="outline"
          size="icon"
          className="rounded size-8 shrink-0"
