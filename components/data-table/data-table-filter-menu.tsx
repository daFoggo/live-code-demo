...
import type { ExtendedColumnFilter, FilterOperator } from "@/lib/types/data-table";
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <Popover open={open} onOpenChange={onOpenChange}>
        ...
        <PopoverContent
          align={align}
          className="p-0 w-full max-w-[var(--radix-popover-content-available-width)] origin-[var(--radix-popover-content-transform-origin)]"
          {...props}
        >
...
}: DataTableFilterItemProps<TData>) {
  {
    ...
    return (
      <div
        ...
        role="listitem"
        id={filterItemId}
        className="flex items-center bg-background rounded-md h-8"
      ...
      >
        <Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
          <PopoverTrigger asChild>
            <Button
              variant="ghost"
              size="sm"
              className="dark:bg-input/30 border border-r-0 rounded-none rounded-l-md font-normal"
            >
              {columnMeta?.icon && (
          ...
          <PopoverContent
            align="start"
            className="p-0 w-48 origin-[var(--radix-popover-content-transform-origin)]"
          >
            <Command loop>
        ...
        >
          <SelectTrigger
            ...
            className="[&_svg]:hidden px-2.5 border-r-0 rounded-none h-8 [&[data-size]]:h-8 lowercase"
          >
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          className="dark:bg-input/30 px-1.5 border border-l-0 rounded-none rounded-r-md h-full font-normal"
  ...
  if (filter.operator === "isEmpty" || filter.operator === "isNotEmpty") {
    return (
      <div
        ...
        aria-live="polite"
        className="bg-transparent dark:bg-input/30 px-1.5 py-0.5 border rounded-none w-16 h-full text-muted-foreground"
      />
    );
  }
    ...
    case "range": {
      if (
        ...
        return (
          <DataTableRangeFilter
            ...
            inputId={inputId}
            onFilterUpdate={onFilterUpdate}
            className="gap-0 [&_input]:px-1.5 [&_[data-slot='range-min']]:border-r-0 [&_input]:rounded-none max-w-28 size-full"
          />
        );
      }
      ...
      return (
        <Input
          ...
          className="px-1.5 rounded-none w-24 h-full"
      ...
      return (
        ...
        >
          <SelectTrigger
            ...
            className="[&_svg]:hidden bg-transparent px-1.5 py-0.5 rounded-none"
          >
        ...
        <Popover open={showValueSelector} onOpenChange={setShowValueSelector}>
          <PopoverTrigger asChild>
            <Button
              ...
              variant="ghost"
              size="sm"
              className="dark:bg-input/30 px-1.5 border rounded-none min-w-16 h-full font-normal"
            >
                    ...
                    {selectedOptions.map((selectedOption) =>
                      selectedOption.icon ? (
                        <div
                          ...
                          className="bg-background p-0.5 border rounded-full"
                        >
        ...
        <Popover open={showValueSelector} onOpenChange={setShowValueSelector}>
          <PopoverTrigger asChild>
            <Button
              ...
              size="sm"
              className={cn(
                "dark:bg-input/30 px-1.5 border rounded-none h-full font-normal",
